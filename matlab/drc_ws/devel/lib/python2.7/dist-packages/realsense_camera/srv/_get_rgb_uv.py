...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_8i().pack(_x.x_min_depth, _x.x_min_xy, _x.y_min_depth, _x.y_min_xy, _x.x_max_depth, _x.x_max_xy, _x.y_max_depth, _x.y_max_xy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x_min_depth, _x.x_min_xy, _x.y_min_depth, _x.y_min_xy, _x.x_max_depth, _x.x_max_xy, _x.y_max_depth, _x.y_max_xy,) = _get_struct_8i().unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4i().pack(_x.x_min_uv, _x.y_min_uv, _x.x_max_uv, _x.y_max_uv))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x_min_uv, _x.y_min_uv, _x.x_max_uv, _x.y_max_uv,) = _get_struct_4i().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
