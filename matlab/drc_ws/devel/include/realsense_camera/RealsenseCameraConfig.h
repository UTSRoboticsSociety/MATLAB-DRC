  ...
  public:
    ...
    public:
      ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
          std::string a_description, std::string a_edit_method, T RealsenseCameraConfig::* a_f) :
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RealsenseCameraConfig::AbstractParamDescriptionConstPtr(new RealsenseCameraConfig::ParamDescription<int>("accuracy", "int", 0, "Accuracy - The projected pattern", "{'enum_description': 'An enum to set accuracy', 'enum': [{'srcline': 12, 'description': '11 patterns, 50fps', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Finest'}, {'srcline': 13, 'description': '10 patterns, 55fps', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Median'}, {'srcline': 14, 'description': '9 patterns, 60fps', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Coarse'}]}", &RealsenseCameraConfig::accuracy)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RealsenseCameraConfig::AbstractParamDescriptionConstPtr(new RealsenseCameraConfig::ParamDescription<int>("filter_option", "int", 0, "The smoothing aggressiveness parameter", "{'enum_description': 'An enum to set filter options', 'enum': [{'srcline': 20, 'description': 'Reports the depth data for high fidelity (high confidence) pixels only, and all other pixels as invalid.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'skeleton'}, {'srcline': 21, 'description': 'Raw depth image without any post-processing filters.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'raw'}, {'srcline': 22, 'description': 'Raw depth image  with the gradient filter applied.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'raw_and_gradients_filter'}, {'srcline': 23, 'description': 'Very low smoothing effect with high sharpness, accuracy levels, and low noise artifacts. Good for any distances of up to 350mm.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'very_close_range'}, {'srcline': 24, 'description': 'Low smoothing effect with high sharpness and accuracy levels. The noise artifacts are optimized for distances between 350mm to 550mm.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'close_range'}, {'srcline': 25, 'description': 'Moderate smoothing effect optimized for distances between 550mm to 850mm to balance between good sharpness level, high accuracy and moderate noise artifacts.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'mid_range'}, {'srcline': 26, 'description': 'High smoothing effect for distances between 850mm to 1000mm bringing good accuracy with moderate sharpness level.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 6, 'ctype': 'int', 'type': 'int', 'name': 'far_range'}, {'srcline': 27, 'description': 'Very high smoothing effect to bring moderate accuracy level for distances above 1000mm. Use together with the MotionRangeTradeOff property to increase the depth range.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 7, 'ctype': 'int', 'type': 'int', 'name': 'very_far_range'}]}", &RealsenseCameraConfig::filter_option)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RealsenseCameraConfig::AbstractParamDescriptionConstPtr(new RealsenseCameraConfig::ParamDescription<int>("filter_option", "int", 0, "The smoothing aggressiveness parameter", "{'enum_description': 'An enum to set filter options', 'enum': [{'srcline': 20, 'description': 'Reports the depth data for high fidelity (high confidence) pixels only, and all other pixels as invalid.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'skeleton'}, {'srcline': 21, 'description': 'Raw depth image without any post-processing filters.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'raw'}, {'srcline': 22, 'description': 'Raw depth image  with the gradient filter applied.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'raw_and_gradients_filter'}, {'srcline': 23, 'description': 'Very low smoothing effect with high sharpness, accuracy levels, and low noise artifacts. Good for any distances of up to 350mm.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'very_close_range'}, {'srcline': 24, 'description': 'Low smoothing effect with high sharpness and accuracy levels. The noise artifacts are optimized for distances between 350mm to 550mm.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'close_range'}, {'srcline': 25, 'description': 'Moderate smoothing effect optimized for distances between 550mm to 850mm to balance between good sharpness level, high accuracy and moderate noise artifacts.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'mid_range'}, {'srcline': 26, 'description': 'High smoothing effect for distances between 850mm to 1000mm bringing good accuracy with moderate sharpness level.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 6, 'ctype': 'int', 'type': 'int', 'name': 'far_range'}, {'srcline': 27, 'description': 'Very high smoothing effect to bring moderate accuracy level for distances above 1000mm. Use together with the MotionRangeTradeOff property to increase the depth range.', 'srcfile': '/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg', 'cconsttype': 'const int', 'value': 7, 'ctype': 'int', 'type': 'int', 'name': 'very_far_range'}]}", &RealsenseCameraConfig::filter_option)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 12 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_Finest = 1;
//#line 13 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_Median = 2;
//#line 14 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_Coarse = 3;
//#line 20 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_skeleton = 0;
//#line 21 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_raw = 1;
//#line 22 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_raw_and_gradients_filter = 2;
//#line 23 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_very_close_range = 3;
//#line 24 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_close_range = 4;
//#line 25 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_mid_range = 5;
//#line 26 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
      const int RealsenseCamera_far_range = 6;
//#line 27 "/home/robosoc/drc_ws/src/realsense_camera/config/RealsenseCamera.cfg"
