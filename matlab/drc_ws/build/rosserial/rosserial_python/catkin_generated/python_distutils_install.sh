...
echo_and_run cd "/home/robosoc/drc_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robosoc/drc_ws/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/robosoc/drc_ws/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
