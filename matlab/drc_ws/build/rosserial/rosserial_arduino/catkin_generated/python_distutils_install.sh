...
echo_and_run cd "/home/robosoc/drc_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robosoc/drc_ws/src/rosserial/rosserial_arduino/setup.py" \
    build --build-base "/home/robosoc/drc_ws/build/rosserial/rosserial_arduino" \
    install \
    $DESTDIR_ARG \
