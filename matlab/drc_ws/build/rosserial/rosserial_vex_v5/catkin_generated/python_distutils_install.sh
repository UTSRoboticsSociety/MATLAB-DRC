...
echo_and_run cd "/home/robosoc/drc_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robosoc/drc_ws/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/robosoc/drc_ws/build/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
